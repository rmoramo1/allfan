...
Revision ID: ec513934a782
Revises: 
Create Date: 2021-10-11 11:01:50.113602
...
def upgrade():
    ...
    sa.Column('juice_total', sa.String(length=150), nullable=False),
    sa.Column('tt_away', sa.Integer(), nullable=False),
    sa.Column('tt_home', sa.Integer(), nullable=False),
    ...
    sa.Column('total_f5', sa.Integer(), nullable=False),
    sa.Column('juice_total_f5', sa.String(length=150), nullable=False),
    sa.Column('tt_away_f5', sa.Integer(), nullable=False),
    sa.Column('tt_home_f5', sa.Integer(), nullable=False),
    ...
    sa.Column('second_half_total', sa.Integer(), nullable=False),
    sa.Column('second_half_juice_total', sa.String(length=150), nullable=False),
    sa.Column('second_half_tt_away', sa.Integer(), nullable=False),
    sa.Column('second_half_tt_home', sa.Integer(), nullable=False),
    ...
    sa.Column('q2_half_total', sa.Integer(), nullable=False),
    ...
    sa.Column('q3_half_total', sa.Integer(), nullable=False),
    sa.Column('q3_half_juice_total', sa.String(length=150), nullable=False),
    sa.Column('q3_half_tt_away', sa.Integer(), nullable=False),
    sa.Column('q3_half_tt_home', sa.Integer(), nullable=False),
    ...
    sa.Column('q4_half_tt_away', sa.Integer(), nullable=False),
    sa.Column('q4_half_tt_home', sa.Integer(), nullable=False),
    ...
    sa.Column('total_1Q', sa.Integer(), nullable=False),
    sa.Column('juice_total_1Q', sa.String(length=150), nullable=False),
    sa.Column('tt_away_1Q', sa.Integer(), nullable=False),
    sa.Column('tt_home_1Q', sa.Integer(), nullable=False),
